    ...
    return (
        <div className="GTC-container">
            ...
            <div className="gtc-section">
                ...
                <div className="gtc-section-text">
                    <p>
                        ...
                        4 rue des Buisses, 59000 LILLE - SIRET 418 541 553 000 32, ci-après désigné par le terme « Nous » ou « Le Prestataire » d’une part, 
                    ...
                    <p>
                        ...
                        Nous nous réservons le droit de facturer les devis suivants, après information préalable au Client. 
                        Si une modification de la commande doit avoir lieu après la signature du devis, un nouveau devis sera édité et Nous ne serons plus tenus des délais initialement convenus.
                    </p>
            ...
            <div className="gtc-section">
                ...
                <div className="gtc-section-text">
                    ...
                    <p>
                        ...
                        Les déplacements ponctuels nécessaires aux rendez-vous physiques de cadrage, de présentation ou de suivi de projet dans un rayon de 30 km autour de Calais sont inclus dans le prix total du devis. 
                        Pour tout déplacement exceptionnel demandé par le Client en dehors de cette zone géographique (sur la région Hauts de France dans un rayon de 130 km autour de Calais), 
                        les modalités et d'éventuels frais de transport seront convenus d’un commun accord et spécifiés à l'avance sur le devis.
                    </p>

                    <h3>Article 7 - Paiement et pénalités de retard</h3>
                    <p>Sauf mention contraire spécifiée sur le devis (Ex : paiement à chaque fin de mois), les modalités de paiement sont les suivantes :</p>
                    <ul>
                        <li>Un acompte correspondant à 30% du montant global de la prestation est exigé dès la signature du devis,</li>
                        <li>Le solde restant de 70% est exigible à la livraison de la prestation ou à la mise en ligne définitive.</li>
                    </ul>
                    <p>
                    ...
                    <p>
                        En cas de défaut de paiement, le Prestataire pourra suspendre immédiatement l'accès au site, à l'hébergement, aux services de maintenance ou aux développements en cours jusqu'au complet règlement des sommes dues.
                    </p>
            ...
            <div className="gtc-section">
                ...
                <div className="gtc-section-text">
                    ...
                    <p>
                        ...
                        dans les 8 jours suivant la livraison de la prestation (réception du site ou de l'application fonctionnel). 
                    ...
                    <p>
                        ...
                        Le Client déclare qu’il dispose notamment des droits et licences pour les outils qui seront utilisés pour la réalisation de la prestation.
                    </p>
                    <p>
                        Le client garantit avoir pris soin de fournir à M. Hochart Jovany le cahier des charges le plus précis possible, détaillant la nature et l’environnement de la commande à réaliser. 
                        Dans le cas contraire, ou si les recommandations ne sont pas assez précises, les 2 parties s’accordent sur le fait que la conception visuelle est laissée à la libre interprétation de M. Hochart Jovany.
                    </p>
                    ...
                    <p>
                        Les prestations réalisées par le Prestataire sont soumises à une obligation de moyens et non à une obligation de résultat. 
                        Le Prestataire s'engage à mettre en œuvre tous les moyens raisonnables nécessaires à la bonne exécution des prestations convenues.
                    </p>
                    <p>
                        Le Client demeure seul responsable de l'utilisation, de l'exploitation et de la gestion des outils, sites internet, applications, codes, contenus, conseils ou services développés dans le cadre de la prestation.
                    </p>
                    <p>
                        Le Client est seul responsable de la sauvegarde de ses données, fichiers, bases de données et documents. Il lui appartient d'effectuer toutes les sauvegardes nécessaires avant toute intervention du Prestataire. 
                        En conséquence, le Prestataire ne pourra être tenu responsable d'une perte, altération ou corruption de données survenant au cours de l'exécution de la prestation ou postérieurement à celle-ci.
                    </p>
                    <p>Le Prestataire ne pourra être tenu responsable des dommages résultants :</p>
                    <ul>
                        <li>D'une mauvaise utilisation des livrables par le Client ou par un tiers,</li>
                        <li>D'une modification du site, du code, de l'application ou de l'infrastructure réalisée par le Client ou par un tiers après la livraison,</li>
                        <li>D'un défaut de maintenance, de mise à jour ou de sécurisation des systèmes exploités par le Client,</li>
                        <li>D'un retard ou d'un manquement du Client dans la fourniture des informations, contenus, accès ou validations nécessaires à la réalisation du projet.</li>
                    </ul>
                    <p>
                        Le Client reconnaît que le projet peut dépendre de services tiers tels que des hébergeurs, registrars, API, CMS, extensions, plugins, services cloud, services d'intelligence artificielle, plateformes de paiement ou tout autre service externe. 
                        Le Prestataire ne saurait être tenu responsable des dysfonctionnements, indisponibilités, interruptions de service, modifications tarifaires, évolutions techniques ou suppressions affectant ces services tiers.
                    </p>
                    <p>
                        Le Prestataire ne garantit pas l'absence totale de bogues, vulnérabilités de sécurité, incompatibilités techniques ou interruptions de service, notamment lorsqu'elles résultent de services tiers, d'hébergeurs, de navigateurs, de mises à jour logicielles, de changements d'environnement technique ou d'actions du Client ou d'un tiers.
                    </p>
                    <p>
                        Sauf contrat de maintenance ou engagement spécifique mentionné au devis, la prestation est réputée achevée à sa livraison. 
                        Toute intervention, assistance, correction, évolution ou maintenance sollicitée après la livraison fera l'objet d'une facturation complémentaire selon le tarif en vigueur.
                    </p>
                    <p>
                        Le Prestataire ne pourra en aucun cas être tenu responsable des dommages indirects subis par le Client, notamment toute perte de bénéfices, perte de chiffre d'affaires, perte d'exploitation, perte de clientèle, perte de données, préjudice commercial ou réclamation formulée par un tiers.
                    </p>
                    <p>
                        En tout état de cause, dans l'hypothèse où la responsabilité du Prestataire serait retenue, pour quelque cause que ce soit, le montant total des indemnités susceptibles d'être mises à sa charge sera expressément limité au montant effectivement payé par le Client au titre de la prestation concernée.
                    </p>
                    <p>
                        <strong>Responsabilité après livraison :</strong> Après livraison et remise des accès administrateur, le Prestataire ne saurait être tenu responsable des modifications réalisées par le Client ou tout tiers sur le site, l'application ou l'infrastructure technique.
                    </p>
                </div>
            </div>
            ...
            <div className="gtc-section">
                ...
                <div className="gtc-section-text">
                    ...
                    <p>
                        ...
                        et à défaut d'accord amiable préalable, seul sera compétent le <strong>Tribunal de Commerce de Lille</strong>, nonobstant pluralité de défendeurs ou appel en garantie.
                    </p>
            ...
            <div className="gtc-link">
                <p>Besoin de renseignements ? </p>
                <NavLink to="/contact" content="Contactez-nous !" id=""/>
